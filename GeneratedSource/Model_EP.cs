...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2301.301 at 5:03 PM on Wednesday, October 15, 2025.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_numberOfIterations_vint0_x has executed. Set this to false to force re-execution of Changed_numberOfIterations_vint0_x</summary>
		public bool Changed_numberOfIterations_vint0_x_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_vint0_Init_x has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vint0_Init_x</summary>
		public bool Changed_numberOfIterationsDecreased_vint0_Init_x_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_vint0_Init_x has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vint0_Init_x</summary>
		public bool Changed_numberOfIterationsDecreased_vint0_Init_x_isInitialised;
		...
		public int vint0
		{
			...
			set {
				if (this.vint0_field!=value) {
					...
					this.Changed_numberOfIterationsDecreased_vint0_Init_x_isDone = false;
					this.Changed_numberOfIterations_vint0_x_isDone = false;
				}
			}
		}
		...
		public bool[][] x
		{
			...
			set {
				...
				this.numberOfIterationsDone = 0;
				this.Changed_vint0_x_isDone = false;
				this.Changed_numberOfIterationsDecreased_vint0_Init_x_isInitialised = false;
				this.Changed_numberOfIterations_vint0_x_isDone = false;
			}
		}
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of numberOfIterations and vint0 and x</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_numberOfIterations_vint0_x(int numberOfIterations)
		{
			if (this.Changed_numberOfIterations_vint0_x_isDone) {
				return ;
			}
			this.pi_marginal_F = ArrayHelper.MakeUniform<Dirichlet>(this.vDirichlet0);
			Dirichlet pi_rep_F_marginal;
			pi_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Dirichlet>(this.vDirichlet0);
			for(int index0 = 0; index0<this.vint0; index0++) {
				this.c_index0__selector_uses_B[index0][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
			}
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				...
				c_index0__selector_cases_uses_B[index0] = new Bernoulli[3][];
			...
			if (this.vint0>0) {
				c_index0__selector_rep_rep_B_reduced = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
			}
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				c_F[index0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
			}
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				...
				c_index0__selector_uses_F[index0][1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
			}
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				...
				c_index0__selector_rep_F[index0] = new Discrete[3];
				for(int index1 = 0; index1<3; index1++) {
					c_index0__selector_rep_F[index0][index1] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
				}
			}
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				// Create array for replicates of 'c_index0__selector_rep_rep_B_toDef'
				c_index0__selector_rep_rep_B_toDef[index0] = new Discrete[3];
				for(int index1 = 0; index1<3; index1++) {
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				// Create array for replicates of 'c_index0__selector_rep_rep_F_marginal'
				c_index0__selector_rep_rep_F_marginal[index0] = new Discrete[3];
				for(int index1 = 0; index1<3; index1++) {
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				// Create array for replicates of 'c_index0__selector_rep_rep_F'
				c_index0__selector_rep_rep_F[index0] = new Discrete[3][];
				for(int index1 = 0; index1<3; index1++) {
					// Create array for 'c_index0__selector_rep_rep' Forwards messages.
					c_index0__selector_rep_rep_F[index0][index1] = new Discrete[5];
					for(int index2 = 0; index2<5; index2++) {
						c_index0__selector_rep_rep_F[index0][index1][index2] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
					}
				}
			}
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				...
				t_index1__B_reduced[index0] = new DistributionStructArray<Beta,double>(5);
				for(int index2 = 0; index2<5; index2++) {
			...
			Beta[][][] t_rep_B = new Beta[3][][];
			for(int index1 = 0; index1<3; index1++) {
				// Create array for replicates of 't_rep_B'
				t_rep_B[index1] = new Beta[5][];
				for(int index2 = 0; index2<5; index2++) {
			...
			Beta[][] t_rep_B_toDef = new Beta[3][];
			for(int index1 = 0; index1<3; index1++) {
				// Create array for replicates of 't_rep_B_toDef'
				t_rep_B_toDef[index1] = new Beta[5];
				for(int index2 = 0; index2<5; index2++) {
					t_rep_B_toDef[index1][index2] = ReplicateOp_Divide.ToDefInit<Beta>(vBeta0);
				}
			}
			// Create array for replicates of 't_rep_F_marginal'
			Beta[][] t_rep_F_marginal = new Beta[3][];
			for(int index1 = 0; index1<3; index1++) {
				// Create array for replicates of 't_rep_F_marginal'
				t_rep_F_marginal[index1] = new Beta[5];
				for(int index2 = 0; index2<5; index2++) {
					t_rep_F_marginal[index1][index2] = ReplicateOp_Divide.MarginalInit<Beta>(vBeta0);
				}
			}
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				// Create array for replicates of 'c_index0__selector_cases_rep2_B'
				c_index0__selector_cases_rep2_B[index0] = new Bernoulli[3][];
				for(int index1 = 0; index1<3; index1++) {
					// Create array for 'c_index0__selector_cases_rep2' Backwards messages.
					c_index0__selector_cases_rep2_B[index0][index1] = new Bernoulli[5];
					for(int index2 = 0; index2<5; index2++) {
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				...
				c_index0__selector_cases_B[index0] = new DistributionStructArray<Bernoulli,bool>(3);
				for(int index1 = 0; index1<3; index1++) {
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				c_index0__selector_B[index0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
			}
			Dirichlet[] pi_rep_B;
			...
			pi_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Dirichlet>(this.vDirichlet0);
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int index1 = 0; index1<3; index1++) {
					for(int index2 = 0; index2<5; index2++) {
						...
						t_rep_F_marginal[index1][index2] = ReplicateOp_Divide.Marginal<Beta>(t_rep_B_toDef[index1][index2], vBeta0, t_rep_F_marginal[index1][index2]);
					}
				}
				for(int index0 = 0; index0<this.vint0; index0++) {
					for(int index1 = 0; index1<3; index1++) {
				...
				pi_rep_F_marginal = ReplicateOp_Divide.Marginal<Dirichlet>(pi_rep_B_toDef, this.vDirichlet0, pi_rep_F_marginal);
				for(int index0 = 0; index0<this.vint0; index0++) {
			...
			this.pi_marginal_F = VariableOp.MarginalAverageConditional<Dirichlet>(pi_rep_B_toDef, this.vDirichlet0, this.pi_marginal_F);
			// Create array for 't_marginal' Forwards messages.
			this.t_marginal_F = new DistributionRefArray<DistributionStructArray<Beta,double>,double[]>(3);
			for(int index1 = 0; index1<3; index1++) {
				// Create array for 't_marginal' Forwards messages.
				this.t_marginal_F[index1] = new DistributionStructArray<Beta,double>(5);
				for(int index2 = 0; index2<5; index2++) {
					this.t_marginal_F[index1][index2] = Beta.Uniform();
					// Message to 't_marginal' from Variable factor
					this.t_marginal_F[index1][index2] = VariableOp.MarginalAverageConditional<Beta>(t_rep_B_toDef[index1][index2], vBeta0, this.t_marginal_F[index1][index2]);
				}
			}
			...
			this.Changed_numberOfIterations_vint0_x_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and vint0 and must reset on changes to x</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_vint0_Init_x(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_vint0_Init_x_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_vint0_Init_x_isInitialised)) {
				return ;
			}
			for(int index0 = 0; index0<this.vint0; index0++) {
				this.pi_rep_F[index0] = ArrayHelper.MakeUniform<Dirichlet>(this.vDirichlet0);
				this.c_index0__selector_uses_B[index0][0] = ArrayHelper.MakeUniform<Discrete>(Discrete.Uniform(3));
			...
			this.Changed_numberOfIterationsDecreased_vint0_Init_x_isDone = true;
			this.Changed_numberOfIterationsDecreased_vint0_Init_x_isInitialised = true;
		}
		...
		private void Changed_vint0_x()
		{
			...
			for(int index0 = 0; index0<this.vint0; index0++) {
				// Create array for 'x_marginal' Forwards messages.
				this.x_marginal_F[index0] = new DistributionStructArray<Bernoulli,bool>(5);
				for(int index2 = 0; index2<5; index2++) {
		...
		private void Constant()
		{
			...
			this.vDirichlet0 = Dirichlet.Uniform(3, Sparsity.FromSpec(StorageType.Dense, 0.0, 0));
			this.vIDistributionLtint__Gt0 = new DistributionRefArray<Discrete,int>(new Discrete[6] {Discrete.PointMass(2, 3), Discrete.PointMass(0, 3), Discrete.PointMass(0, 3), Discrete.PointMass(0, 3), Discrete.PointMass(0, 3), Discrete.PointMass(1, 3)});
			// Create array for replicates of 't_rep_F'
			this.t_rep_F = new Beta[3][][];
			for(int index1 = 0; index1<3; index1++) {
				// Create array for replicates of 't_rep_F'
				this.t_rep_F[index1] = new Beta[5][];
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Constant();
			this.Changed_vint0();
			this.Changed_numberOfIterationsDecreased_vint0_Init_x(initialise);
			this.Changed_numberOfIterations_vint0_x(numberOfIterations);
